...
public class TestDataGenerator {
    ...
    public Graph generateRandomGraph(int vertices, int edges, int maxWeight) {
        ...
        // Ensure the graph is connected by creating a path through all vertices
        ...
        int remainingEdges = Math.max(0, edges - (vertices - 1));
        int attempts = 0;
        int maxAttempts = remainingEdges * 10; // Avoid infinite loop
